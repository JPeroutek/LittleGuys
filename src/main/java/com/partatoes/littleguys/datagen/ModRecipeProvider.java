...
public class ModRecipeProvider  extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModItems.LITTLEGUY_ITEM, 4)
                ...
                .offerTo(exporter, Identifier.of(LittleGuys.MOD_ID, "littleguys_from_clay_and_soulsand"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModItems.LITTLEGUY_ITEM, 1)
                ...
                .offerTo(exporter, Identifier.of(LittleGuys.MOD_ID, "littleguy_from_clay_ball_and_soulsand_pile"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModItems.LITTLEHORSE_ITEM, 1)
                ...
                .offerTo(exporter, Identifier.of(LittleGuys.MOD_ID, "littlehorse_from_clay_balls_and_soulsand_pile"));
        ...
        ModItems.LITTLEGUY_COLORS.forEach((dc, item) -> ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, item)
