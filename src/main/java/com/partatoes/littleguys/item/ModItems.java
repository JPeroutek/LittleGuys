...
import com.partatoes.littleguys.item.custom.LittleGuyItem;
...
public class ModItems {
    ...
    public static final Item LITTLEGUY_ITEM = registerItem("littleguy_item", new LittleGuyItem(new Item.Settings()));
